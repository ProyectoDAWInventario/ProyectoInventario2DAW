              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu bg-light">
                      ...
                      <hr>
                      <li><a class="dropdown-item" href="../../archivosComunes/logout.php">Salir</a></li>
                    </ul>
                  </li>
              </ul>
              <hr class="text-white-50">
      ...
      <div class="container px-4 py-5" id="Incidencias">
        ...
        <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
          ...
          try {
            ...
            $consulta_dep = "SELECT DEPARTAMENTO FROM usuario where EMAIL = '$email'";
            $consulta_dep = $db->query($consulta_dep);

            $incidencias = "SELECT * FROM tareas where TIPO_INCIDENCIA='centro'";
