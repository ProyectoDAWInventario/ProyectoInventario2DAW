      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="menu">
          <ul class="navbar-nav me-auto">
            <li class="nav-item"><a class="nav-link active" href="#">Incidencias</a></li>
          </ul>
      ...
      <div class="container px-4 py-5" id="Incidencias">
        ...
        <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
          ...
          try {
            ...
            $consulta_dep = "SELECT * FROM usuario where EMAIL = '$email' and DEPARTAMENTO = 1";
            $consulta_dep = $db->prepare($consulta_dep);
            $consulta_dep->execute();

            if ($consulta_dep->rowCount() > 0) {
              $incidencias = "SELECT * FROM tareas where TIPO_INCIDENCIA='informatica'";
